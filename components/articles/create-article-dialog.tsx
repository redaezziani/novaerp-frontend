...
export function CreateArticleDialog({
  open,
  onOpenChange,
}: CreateArticleDialogProps): React.ReactElement {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(getApiErrorMessage(err, "Impossible de créer l'article."));
    }
  };
        ...
        <Form onSubmit={handleSubmit} id="create-article-form">
          <DialogPanel className="flex max-h-[70vh] flex-col gap-4 overflow-y-auto">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <Field>
                <FieldLabel htmlFor="unitId">Unité</FieldLabel>
                <Select
                  items={(units ?? []).map((u) => ({
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <Field>
                <FieldLabel htmlFor="unitCostTtc">Coût unitaire TTC</FieldLabel>
                <Input
                  id="unitCostTtc"
                  type="number"
                  min="0"
              ...
              <Field>
                <FieldLabel htmlFor="salePriceHt">Prix de vente HT</FieldLabel>
                <Input
                  id="salePriceHt"
                  type="number"
                  min="0"
            ...
            <div className="grid grid-cols-2 gap-4">
              <Field>
                <FieldLabel htmlFor="minStockQuantity">
                  Stock minimum
                </FieldLabel>
                <Input
                  id="minStockQuantity"
              ...
              <Field className="flex-row items-center justify-between pt-6">
                <FieldLabel htmlFor="serialTracked">
